...
export const Token = new Factory(
  Contract.fromJson(
    TokenContractJson,
    "",
    "03cbbd308bd80bfe297a4bc92ee1db1f4803983033792c0ec9d4b69220ad4d3e",
    []
  )
);
...
export class TokenInstance extends ContractInstance {
  ...
  view = {
    ...
    burn: async (
      params: TokenTypes.CallMethodParams<"burn">
    ): Promise<TokenTypes.CallMethodResult<"burn">> => {
      return callMethod(Token, this, "burn", params, getContractByCodeHash);
    },
  };
  ...
  transact = {
    ...
    burn: async (
      params: TokenTypes.SignExecuteMethodParams<"burn">
    ): Promise<TokenTypes.SignExecuteMethodResult<"burn">> => {
      return signExecuteMethod(Token, this, "burn", params);
    },
  };
